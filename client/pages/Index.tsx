    ...
    <div className="w-[2160px] h-[3840px] bg-medical-red-complex mx-auto">
      ...
      <div className="relative px-[150px] pt-[232px] pb-[200px]">
        ...
        <div className="text-center space-y-8 max-w-[1884px] mx-auto">
          ...
          <div className="text-gradient-gold text-[150px] font-bold leading-[140px]">
      ...
      <div className="px-[150px] space-y-16 pb-[300px]">
        ...
        >
          The risk of <span className="font-bold">life-threatening acute pancreatitis (AP)</span> associated with sHTG is serious and demands urgent action<span className="text-[24px] align-top">8</span>
        </InfoCard>
        ...
        >
          sHTG <span className="font-bold">substantially increases a person's risk of atherosclerotic cardiovascular disease (ASCVD)</span><span className="text-[24px] align-top">1,9</span>
        </InfoCard>
        ...
        >
          The full <span className="font-bold">physical and mental impact</span> of sHTG on patients, from <span className="font-bold">metabolic dysfunction-associated steatohepatitis (MASH) to brain fog</span>, is likely underestimated<span className="text-[24px] align-top">10,11</span>
        </InfoCard>
        ...
        >
          sHTG is <span className="font-bold">difficult to control, requiring vigilant management and urgent intervention</span> with standard-of-care treatment<span className="text-[24px] align-top">7,12</span>
        </InfoCard>
      </div>
